...
ethnic = input("Enter ethnic background: ")
age = input("Enter age: ")
gender = input("Enter gender (Male/Female): ")
city = input("City:")
PROMPT = "Generate the city of" + city + "from a street view with a " + age + "year old" + ethnic + gender + "standing on the road smiling"
...
try:
    ...
    while True:
        ...
        ret, frame = cap.read()
        # frame = cv2.resize(frame, (640, 1024))
...
dall_e_path = os.path.join(IMAGE_DIR, image_file.name)
img = cv2.imread("picture.jpg")
img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
mask = np.zeros_like(img_gray)
img2 = cv2.imread(dall_e_path)
